...
namespace SDO_Integrated_System.Inventory.Forms
{
    public partial class MainForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            // TODO: This line of code loads data into the 'dataSet_ListOfSchools.tbl_Schools' table. You can move, or remove it, as needed.
            this.tbl_SchoolsTableAdapter.Fill(this.dataSet_ListOfSchools.tbl_Schools);
            // TODO: This line of code loads data into the 'dataSet_ListOfSchools.tbl_Schools' table. You can move, or remove it, as needed.



        }
        private void ListOfTeacher()
        {
            Connection();
            SqlCommand com = new SqlCommand("SELECT concat([UserID],[FName],[MName],[LName],[NameExt]) as Name ,[Designation],[PositionTitle],[Contact] FROM [dbo].[AntiqueUsers] where SchoolID='"+tbSchoolID.Text+"'", conn);
